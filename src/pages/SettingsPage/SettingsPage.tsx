    ...
    <div className={styles["settings-page"]}>
      <div className={styles["content"]}>
        <div className={styles["left-panel"]}>
          <h2>Configured Time Blocks</h2>
          <ul className={styles["time-block-list"]}>
            {timeBlocks.map((block, index) => (
              <li key={block.id} className={styles["time-block-item"]}>
        ...
        <div className={styles["right-panel"]}>
          ...
          <div className={styles["input-group"]}>
            <label htmlFor="new-time-block">Duration (minutes)</label>
            <input
              id="new-time-block"
              type="number"
              min="1"
